...
// ReSharper restore InconsistentNaming
        ...
        internal Connection(Server server, Socket socket, X509Certificate certificate): this(server, socket)
        {
            if (certificate != null)
            {
...
// ReSharper restore InconsistentNaming
        ...
        /// 
        /// </summary>
        public virtual LogInfo RequestLog
        {
        ...
        /// 
        /// </summary>
        public virtual LogInfo ResponseLog
        {
        ...
        public virtual void LogRequest(string pathTranslated, string url)
        {
        ...
        public virtual void LogRequestBody(byte[] content)
        {
        ...
        public virtual void LogRequestHeaders(string headers)
        {
        ...
        /// <returns></returns>
        public virtual byte[] ReadRequestBytes(int maxBytes)
        {
            try
            {
                if (_sslStream != null)
                {
                    byte[] sslBuffer = new byte[maxBytes];

                    int c =_sslStream.Read(sslBuffer, 0, maxBytes);

                    if (c < maxBytes)
                    {
                        var resBytes = new byte[c];
                        Buffer.BlockCopy(sslBuffer, 0, resBytes, 0, c);
        ...
        /// </summary>
        /// <returns></returns>
        public virtual int WaitForRequestBytes()
        {
            int availBytes = 0;
        ...
        /// 
        /// </summary>
        public virtual void Write100Continue()
        {
            WriteEntireResponseFromString(100, null, null, true);
        }

        internal virtual void Write200Continue()
        {
        ...
        public virtual void WriteBody(byte[] data, int offset, int length)
        {
            try
            {
        ...
        public virtual void WriteEntireResponseFromFile(String fileName, bool keepAlive)
        {
            ...
            try
            {
                ...
                Send(Encoding.UTF8.GetBytes(headers));

                Send(fileBytes, 0, bytesRead);
        ...
        /// <param name="keepAlive"></param>
        public virtual void WriteEntireResponseFromString(int statusCode, String extraHeaders, String body, bool keepAlive)
        {
            try
            {
                ...
                Send(Encoding.UTF8.GetBytes(headers + body));
            }
            catch (SocketException)
            {
            }
        ...
        public virtual void WriteErrorAndClose(int statusCode, string message)
        {
        ...
        /// </summary>
        /// <param name="statusCode"></param>
        public virtual void WriteErrorAndClose(int statusCode)
        {
        ...
        /// <param name="statusCode"></param>
        /// <param name="extraHeaders"></param>
        public virtual void WriteErrorWithExtraHeadersAndKeepAlive(int statusCode, string extraHeaders)
        {
        ...
        /// <param name="statusCode"></param>
        /// <param name="extraHeaders"></param>
        public virtual void WriteHeaders(int statusCode, String extraHeaders)
        {
